...
class PickUpPlacePredictionTileDesign extends StatelessWidget
{
  final PredictedPlaces? predictedPlaces;

  PickUpPlacePredictionTileDesign({this.predictedPlaces});
  ...
  getPlaceDirectionDetails(String? placeId, context) async
  {
    ...
    if(responseApi["status"] == "OK")
    {
      ...
      Map<String, dynamic> result = {
        'status': 'obtainedPickUp',
        'selectedLocation': directions.locationName,
      };
